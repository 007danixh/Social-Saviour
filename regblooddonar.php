  ...
  <body>
    ...
    <div class="container">
      ...
      <?php
               ...
               if(strpos($fullurl, "blooddonar=registered")==true){
                 echo"<p class='success'>You have been Registered as Blood Donar,Thank You...</p>";
                 

               }
               ?>
        <h2>Register As Blood Donar</h2>
        <hr class="light">
        <p> Fill in following details:</p>
      </div>
      <div class="row">
        <div class="column">
          <img src="img/blooddon.jpg" style="width:100%  ">
        </div>
        <div class="column">
          <form action="regbloodlogic.php" method="POST">
            ...
            <input type="text" id="fname" name="bloodgroup" placeholder="Your Blood Group.." required>
